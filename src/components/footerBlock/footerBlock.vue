      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a @click="gotoFB()" class="flex items-center">
              <img
                src="@\assets\logo.png"
                class="h-8 me-3"
                alt="FlowBite Logo"
        ...
        <div class="md:flex md:items-center md:justify-between">
          <span class="text-base text-gray-400 md:text-center"
            >© 2024 維娜平片設計 版權所有。有任何問題請聯繫 s770880qq@gmail.com
          </span>
          <div class="flex mt-4 md:justify-center md:mt-0 gap-10">
            ...
            <a
              href="https://github.com/cactus1998"
            ...
            <a @click="gotoShopee()" class="text-gray-400 hover:text-gray-900">
              <svg
                class="w-6 h-6"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
